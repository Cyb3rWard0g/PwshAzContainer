#
# Module manifest for module 'PwshAzContainerApp'
#
...
Description = 'PowerShell module for Azure Container Apps'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/Cyb3rWard0g/PwshAzContainerApp'
